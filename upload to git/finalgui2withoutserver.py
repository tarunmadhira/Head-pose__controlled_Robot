        ...
        if ret:
            ...
            if len(face_rects) > 0:
                ...
                if ((euler_angle[1, 0] < 15) and (euler_angle[1, 0] > (-15))):
                    if ((euler_angle[0, 0] > 0 and euler_angle[0, 0] <15)):
                        cv2.putText(frame, "DOWN", (20, 140), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (0, 0, 0), thickness=2)
                        command = "backward\n"
                    elif ((euler_angle[0, 0]) >15):
                        cv2.putText(frame, "DOWN1", (20, 140), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (0, 0, 0), thickness=2)
                        command = "backward1\n"
                    elif ((euler_angle[0, 0]) < 0 and euler_angle[0, 0]>-15 ):
                        cv2.putText(frame, "UP", (20, 140), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (0, 0, 0), thickness=2)
                        command = "forward\n"
                    elif ((euler_angle[0, 0]) < -15 and euler_angle[0, 0]>-25):
                        cv2.putText(frame, "UP1", (20, 140), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (0, 0, 0), thickness=2)
                        command = "forward1\n"
                    elif ((euler_angle[0, 0]) < -25):
                        cv2.putText(frame, "UP2", (20, 140), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (0, 0, 0), thickness=2)
                        command = "forward2\n"
                elif (euler_angle[1, 0] > 15 and euler_angle[1, 0] <30):
                    cv2.putText(frame, "RIGHT", (20, 140), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (0, 0, 0), thickness=2)
                    command = "right\n"
                elif (euler_angle[1, 0] > 30):
                    cv2.putText(frame, "RIGHT1", (20, 140), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (0, 0, 0), thickness=2)
                    command = "right1\n"
                elif (euler_angle[1, 0] < (-30)):
                    cv2.putText(frame, "LEFT1", (20, 140), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (0, 0, 0), thickness=2)
                    command = "left1\n"
                elif (euler_angle[1, 0] < (-15) and euler_angle[1, 0] > (-30)):
                    cv2.putText(frame, "LEFT", (20, 140), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (0, 0, 0), thickness=2)
                    command = "left\n"
...
window = Tk()
window.title("wheelchair command window")
statusvar = StringVar()
...
label10 = Label(window, text="press to see head pose in real time")
...
button9 = Button(window, text="full code without robot", command=vidheadpose, fg="red", bg="green", highlightbackground="red")
